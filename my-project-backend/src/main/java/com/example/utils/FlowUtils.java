...
public class FlowUtils {
    ...
    /**
     * 针对在时间段内多次请求限制，如3秒20次请求
     * @param counterKey
     * @param frequently
     * @param period
     * @return
     */
    public boolean limitPeriodCounterCheck(String counterKey, int frequently, int period){
        return this.internalCheck(counterKey, frequently, period, defaultAction);
